        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="product__details__img">
                    <div class="product__details__big__img">
                        <img class="big_img" src="${cake.src}" alt="">
                    </div>
            ...
            <div class="col-lg-6">
                <div class="product__details__text">
                    ...
                    <h4>${cake.foodName}</h4>
                    <h5>Rs:${cake.price}.00</h5>
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, eiusmod tempor incididunt ut labore
                        et dolore magna aliqua. Quis ipsum suspendisse ultrices gravida</p>
                    <p>${cake.l_description}</p>
                    <ul>
                        <li>Size: <span>${cake.s_description}</span></li>
                        <li>Category: <span>${cake.category}</span></li>
                    </ul>
                    <div class="product__details__option">
                        <a href="/cake" class="primary-btn">Continue Shopping</a>
