...
//    private String ingredients;
   ...
   private List<OrderDetail> restaurantCounterOrderDetails = new ArrayList<>();
    ...
    public FoodItem(int itemId, String foodName, String s_description, int price) {
        this.itemId = itemId;
    ...
    public FoodItem(int itemId,String foodName ,int price, String src) {
        this.itemId=itemId;
        this.foodName = foodName;
        this.price = price;
        this.src = src;
    ...
    public FoodItem(int itemId, String foodName, String s_description, String l_description, int price) {
        this.itemId = itemId;
        this.foodName = foodName;
        this.s_description = s_description;
    ...
    public FoodItem(int itemId, String foodName, String s_description, String l_description, int price, String src) {
        this.itemId = itemId;
        this.foodName = foodName;
        this.s_description = s_description;
        this.l_description = l_description;
