...
<%--    &lt;%&ndash;    <div class="offcanvas__option">&ndash;%&gt;--%>
<%--    &lt;%&ndash;        <ul>&ndash;%&gt;--%>
<%--    &lt;%&ndash;            <li>USD <span class="arrow_carrot-down"></span>&ndash;%&gt;--%>
<%--    &lt;%&ndash;                <ul>&ndash;%&gt;--%>
<%--    &lt;%&ndash;                    <li>EUR</li>&ndash;%&gt;--%>
<%--    &lt;%&ndash;                    <li>USD</li>&ndash;%&gt;--%>
<%--    &lt;%&ndash;                </ul>&ndash;%&gt;--%>
<%--    &lt;%&ndash;            </li>&ndash;%&gt;--%>
<%--    &lt;%&ndash;            <li>ENG <span class="arrow_carrot-down"></span>&ndash;%&gt;--%>
<%--    &lt;%&ndash;                <ul>&ndash;%&gt;--%>
<%--    &lt;%&ndash;                    <li>Spanish</li>&ndash;%&gt;--%>
<%--    &lt;%&ndash;                    <li>ENG</li>&ndash;%&gt;--%>
<%--    &lt;%&ndash;                </ul>&ndash;%&gt;--%>
<%--    &lt;%&ndash;            </li>&ndash;%&gt;--%>
<%--    &lt;%&ndash;            <li><a href="#">Sign in</a> <span class="arrow_carrot-down"></span></li>&ndash;%&gt;--%>
<%--    &lt;%&ndash;        </ul>&ndash;%&gt;--%>
<%--    &lt;%&ndash;    </div>&ndash;%&gt;--%>
<%--</div>--%>
<%--<!-- Offcanvas Menu End -->--%>
...
<%--                            </div><br>--%>
<%--                            &lt;%&ndash;                            <div class="header__top__right__cart" style="float: right;margin-right:20px;">&ndash;%&gt;--%>
<%--                            &lt;%&ndash;                                <a href="/shoppingCartNew" class="cart-icon" ><img src="../../cake-main/img/icon/cart.png" alt=""> <span>0</span></a>&ndash;%&gt;--%>
<%--                            &lt;%&ndash;                            </div>&ndash;%&gt;--%>
<%--                        </div>--%>
<%--                    </div>--%>
<%--                </div>--%>
...
<%--&lt;%&ndash;                        <div class="hero__text">&ndash;%&gt;--%>
<%--&lt;%&ndash;                            <h2>Making your life sweeter one bite at a time!</h2>&ndash;%&gt;--%>
<%--&lt;%&ndash;                            <a href="#" class="primary-btn">Our cakes</a>&ndash;%&gt;--%>
<%--&lt;%&ndash;                        </div>&ndash;%&gt;--%>
<%--&lt;%&ndash;                    </div>&ndash;%&gt;--%>
<%--&lt;%&ndash;                </div>&ndash;%&gt;--%>
<%--&lt;%&ndash;            </div>&ndash;%&gt;--%>
...
<%--&lt;%&ndash;<!-- Categories Section Begin -->&ndash;%&gt;--%>
<%--&lt;%&ndash;<div class="categories">&ndash;%&gt;--%>
<%--&lt;%&ndash;    <div class="container">&ndash;%&gt;--%>
<%--&lt;%&ndash;        <div class="row">&ndash;%&gt;--%>
<%--&lt;%&ndash;            <div class="categories__slider owl-carousel">&ndash;%&gt;--%>
<%--&lt;%&ndash;                <div class="categories__item">&ndash;%&gt;--%>
<%--&lt;%&ndash;                    <div class="categories__item__icon">&ndash;%&gt;--%>
<%--&lt;%&ndash;                        <img style="border-radius: 50%;"src="../../img/birthday.jpg" alt=""  height="170">&ndash;%&gt;--%>
<%--&lt;%&ndash;                        <h5>Birthday</h5>&ndash;%&gt;--%>
<%--&lt;%&ndash;                    </div>&ndash;%&gt;--%>
<%--&lt;%&ndash;                </div>&ndash;%&gt;--%>
<%--&lt;%&ndash;                <div class="categories__item">&ndash;%&gt;--%>
<%--&lt;%&ndash;                    <div class="categories__item__icon">&ndash;%&gt;--%>
<%--&lt;%&ndash;                        <img style="border-radius: 50%;"src="../../img/anniv.jpg" alt=""  height="170">&ndash;%&gt;--%>
<%--&lt;%&ndash;                        <h5>Anniversary</h5>&ndash;%&gt;--%>
<%--&lt;%&ndash;                    </div>&ndash;%&gt;--%>
<%--&lt;%&ndash;                </div>&ndash;%&gt;--%>
<%--&lt;%&ndash;                <div class="categories__item">&ndash;%&gt;--%>
<%--&lt;%&ndash;                    <div class="categories__item__icon">&ndash;%&gt;--%>
<%--&lt;%&ndash;                        <img style="border-radius: 50%;"src="../../img/cupcake.jpg" alt=""  height="170">&ndash;%&gt;--%>
<%--&lt;%&ndash;                        <h5>Cupcake</h5>&ndash;%&gt;--%>
<%--&lt;%&ndash;                    </div>&ndash;%&gt;--%>
<%--&lt;%&ndash;                </div>&ndash;%&gt;--%>
<%--&lt;%&ndash;                <div class="categories__item">&ndash;%&gt;--%>
<%--&lt;%&ndash;                    <div class="categories__item__icon">&ndash;%&gt;--%>
<%--&lt;%&ndash;                        <img style="border-radius: 50%;"src="../../img/chri.jpg" alt=""  height="170">&ndash;%&gt;--%>
<%--&lt;%&ndash;                        <h5>Christmas</h5>&ndash;%&gt;--%>
<%--&lt;%&ndash;                    </div>&ndash;%&gt;--%>
<%--&lt;%&ndash;                </div>&ndash;%&gt;--%>
<%--&lt;%&ndash;                <div class="categories__item">&ndash;%&gt;--%>
<%--&lt;%&ndash;                    <div class="categories__item__icon">&ndash;%&gt;--%>
<%--&lt;%&ndash;                        <img style="border-radius: 50%;"src="../../img/Cupcaketag.jpg" alt=""  height="170">&ndash;%&gt;--%>
<%--&lt;%&ndash;                        <h5>Donut</h5>&ndash;%&gt;--%>
<%--&lt;%&ndash;                    </div>&ndash;%&gt;--%>
<%--&lt;%&ndash;                </div>&ndash;%&gt;--%>
<%--&lt;%&ndash;                <div class="categories__item">&ndash;%&gt;--%>
<%--&lt;%&ndash;                    <div class="categories__item__icon">&ndash;%&gt;--%>
...
<%--&lt;%&ndash;    </div>&ndash;%&gt;--%>
<%--&lt;%&ndash;</div>&ndash;%&gt;--%>
<%--&lt;%&ndash;<!-- Categories Section End -->&ndash;%&gt;--%>

<%--<div class="categories">--%>
<%--    <div class="container">--%>
<%--        <div class="row">--%>
<%--            <section class="categories__slider owl-carousel owl-nav">--%>
<%--&lt;%&ndash;                    <button type="button" role="presentation" class="owl-prev">&ndash;%&gt;--%>
...
<%--            </div>--%>
<%--                    </div>--%>
<%--                        <div class="owl-item cloned" style="width: 216px; margin-right: 22px;"><div class="categories__item">--%>
<%--                <div class="categories__item__icon">--%>
...
<%--&lt;%&ndash;                <button type="button" role="presentation" class="owl-next">&ndash;%&gt;--%>
<%--&lt;%&ndash;                    <i class="fa fa-angle-right"><i></i></i>&ndash;%&gt;--%>
<%--&lt;%&ndash;                </button>&ndash;%&gt;--%>
<%--&lt;%&ndash;                <div>&ndash;%&gt;--%>
<%--&lt;%&ndash;                    <ion-icon name="arrow-forward-outline"></ion-icon>&ndash;%&gt;--%>
<%--&lt;%&ndash;                </div>&ndash;%&gt;--%>
<%--            </div>--%>
<%--        </div>--%>
<%--    </div>--%>
...
<%--                    </button></div><div class="owl-dots disabled"></div></section>--%>
<%--                </div></div></div>--%>
<%--            </div>--%>
<%--    </div>--%>
<%--</div>--%>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="header__top__inner">
                        ...
                        <div class="header__logo">
                            <a href=""><img src="../../cake-main/img/logoo.png" style="height:110px; weight:60px; padding-left: 75px;" alt=""></a>
                        </div>
                        <div class="header__top__right">
                            <div class="header__top__right__links header__top__right__cart" >
                                <a href="/signUp" class="register" style="color: black; margin-left:50px">Register</a>
