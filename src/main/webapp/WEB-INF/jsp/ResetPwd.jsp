            ...
            <div class="col-lg-12">
                <div class="signup-content" style="margin-bottom:10px; margin-top: 25px">
                    <div class="signup-form">
                        <h2 class="form-title" style="color: black"><b>Reset Your Password</b></h2>
                        ...
                        <form method="POST" class="register-form" id="register-form" action="/reset_passwordd" onsubmit="return verifyPassword() ">
<%--                            <input class="form-control" name="onlineCustomerId" value="0" id="onlineCustomerId" type="hidden">--%>
...
<%--        <label for="your_name"><i class="zmdi zmdi-lock"></i></label>--%>
    ...
    <div class="form-group">
        ...
        <input type="password" name="re_pass" id="re_pass" placeholder="Confirm your new password" onkeyup="check();" required />
